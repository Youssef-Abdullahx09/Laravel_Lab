    ...
    <div class="container">
        ...
        <form action="{{ route('posts.store') }}" method="post">
            ...
            <div class="mb-3">
                ...
                <textarea name="description" class="form-control" placeholder="Post Description" id="" cols="30"
                    rows="7"></textarea>
            </div>
            <div class="mb-3">
            ...
            <button type="submit" class="btn btn-primary" style="width: 150px"><i class="bi bi-plus-circle"></i>
                Post</button>
        </form>
    </div>
