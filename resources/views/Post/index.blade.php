          ...
          <tbody class="table-group-divider">
            ...
            <tr class="table-info">
                ...
                <td class="text-end px-5">
                  ...
                  >
                     <form class="btn btn-danger m-0" style="width: 100px"  action="{{ route("posts.destroy", $post["id"]) }}" method="post" >
                        @csrf
                        @method("delete")
                      <input type="submit" class="p-0 m-0 bg-danger border-0"aria-describedby="helpId" value="Delete">
                    </form>
                </td>
              </tr>
            @endforeach
